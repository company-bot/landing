...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { label: 'Pricing', href: '#accessible-learning' },
          ...
          <div className="flex flex-col gap-4 p-6">
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => handleNavClick(e, link.href)}
                className="font-bold text-base uppercase tracking-wider text-gray-800 dark:text-gray-400 hover:text-cyan dark:hover:text-cyan transition-colors"
              >
                {link.label}
              </a>
            ))}
